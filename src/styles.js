const styles = {
  ...
  heroHeadText:
    'inline font-black text-eerieBlack text-[50px] xl:text-[80px] mt-10',
  heroTextLight:
    'font-black text-[#0077B5] text-[30px] lg:text-[70px]',
  heroSubText:
    'text-battleGray font-medium text-[15px] lg:text-[25px]',
