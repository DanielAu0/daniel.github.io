const styles = {
  ...
  heroTextLight:
    'font-black text-jetGray lg:text-[60px] sm:text-[40px] xs:text-[30px] text-[20px] lg:leading-[80px] mt-2',
  heroSubText:
    'text-eerieBlack font-medium lg:text-[20px] sm:text-[16px] xs:text-[10px] text-[6px] lg:leading-[30px]',
